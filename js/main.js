class Main {
  constructor() {
    this.default = {
      ...
      quote: {
        // https://github.com/ajzbc/kanye.rest/blob/11d4b2b798274ceaab74dac36d1a98e2137289aa/quotes.json
        KanyeWest: [
          "2024",
  ...
  _modify__HTML__2 = () => {
    ...
    for (const i of document.querySelectorAll(".radio-1")) {
      i.remove();
    }
    ...
    for (const i of this.default.localStorage.array) {
      document.getElementById(
        "_div__inputRadio"
      ).innerHTML += ` <div class="field-row radio-1">
      <input
  ...
  _modify__HTML__3 = () => {
    ...
    // setInterval(this._modify__HTML__3, 3e3);
  };
